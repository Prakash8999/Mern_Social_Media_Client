...
const Navbar = () => {
	...
	return (
		<>
			<div className='hidden md:block relative w-full pb-2 pr-2'>
				<div className='flex justify-end '>


					<div className='flex justify-center gap-x-10 items-center h-[10vh] border-b  w-[72vw]'>
						...
						<div className='w-[50vw]'>
							...
							<div className="relative  h-10 ">
								...
								<input type="search" id="default-search" className=" block w-full h-10 pl-10 pr-2  text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white outline-none" placeholder="Search Users" required />
								{/* <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button> */}
							</div>

						</div>
						<p className='  px-4  rounded-md outline-none border text-center py-2'>
